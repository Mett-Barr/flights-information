...
fun CalculatorKeyboard(
    ...
    Column(modifier = modifier) {
        Row(
            ...
            IconButton(
                painter = painterResource(id = R.drawable.ic_backspace_fill0_wght400_grad0_opsz48),
        ...
        Row(modifier = Modifier.padding(horizontal = 4.dp)) {
            ...
            TextButton(string = "-", modifier, {
                when (calculator.currentState.value) {
                    CurrentState.NULL, CurrentState.ZERO, CurrentState.INTEGER, CurrentState.DOUBLE, CurrentState.RIGHT -> true
                    else -> false
                }
